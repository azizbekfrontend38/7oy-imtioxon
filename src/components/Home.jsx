...
import iconWhole from "../../assets/images/icon-whole-food-recipes.svg";
import iconFuss from "../../assets/images/icon-minimum-fuss.svg";
...
export default function Home() {
  return (
    <div className="container mx-auto mt-[80px] pr-5 pl-5 font-nunito">
      <div className="lg:text-center">
        ...
        {/* HERO SECTION */}
        <section className="container mx-auto mt-8 bg-neutral-0 px-5 py-5 rounded-[15px] mb-[90px]">
          <picture>
            <source media="(max-width: 500px)" srcSet={heroSmall} />
            <img src={heroLarge} alt="hero" />
          </picture>
        </section>
      </div>
      ...
      <div>
        <div className="flex justify-center items-center max-lg:flex-col">
          ...
          <picture className="lg:flex gap-[45px]">
            <source media="(max-width: 500px)" srcSet={lifeSmall} />
            <img className="rounded-[20px]" src={lifeLarge} alt="real life" />
          </picture>
        </div>
      </div>
    </div>
