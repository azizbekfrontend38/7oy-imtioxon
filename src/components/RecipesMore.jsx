...
export default function RecipesMore() {
  ...
  return (
    <div className="container mx-auto px-4 py-10 mt-50">
      {/* Skeleton loader */}
      {pending && (
        <motion.div
          className="flex flex-col lg:flex-row gap-10 bg-white shadow-lg rounded-2xl overflow-hidden p-6 animate-pulse"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1 }} // sekinroq animatsiya
        >
          {/* Image skeleton */}
          <div className="w-full lg:w-1/2 h-72 bg-gray-200 rounded-2xl"></div>
          ...
          <div className="flex flex-col gap-6 lg:w-1/2">
            ...
            <ul className="space-y-2">
              <li className="h-4 w-full bg-gray-200 rounded"></li>
